...
public class AsyncBookmarkDelete extends AsyncTask<Void, Integer, Void> {


    private String params = "";
    String TestVAR;
    private Context mContext;
    private String iShopID, iUserID, iNick;
    private String userLocationCheckResult;
    String parseUrlParameter = "http://222.122.203.55/realreview/bookmark/bookmarkDelete.php?";
    private MaterialDialog builder;


    public AsyncBookmarkDelete(String iShopID, String iUserID, String iNick, Context mContext) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Log.d("AsyncBookmarkDelete", "parseUrlParameter : " + parameterCheck);
            Log.d("AsyncBookmarkDelete", "url : " + url);
            ...
            Log.d("AsyncBookmarkDelete", "전송결과 : " + result);
