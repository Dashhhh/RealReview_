...
public class AsyncReviewUsefulDown extends AsyncTask<Void, Integer, Void> {
    ...
    String parseUrlParameter = "http://222.122.203.55/realreview/reviewScore/reviewUsefulDown.php?";
    private MaterialDialog builder;


    public AsyncReviewUsefulDown(String iShopID, String iUserID, String iNick, String iIdx, Context mContext) {
