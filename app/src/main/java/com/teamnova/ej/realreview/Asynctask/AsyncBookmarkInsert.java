...
public class AsyncBookmarkInsert extends AsyncTask<Void, Integer, Void> {
    ...
    String parseUrlParameter = "http://222.122.203.55/realreview/bookmark/bookmarkInsert.php?";
    private MaterialDialog builder;

    public AsyncBookmarkInsert(String iShopID, String iUserID, String iNick, Context mContext) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Log.d("Useful_OnCheckedChanged", "전송결과 : " + result);
