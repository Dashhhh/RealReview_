...
public class AsyncReviewUsefulUp extends AsyncTask<Void, Integer, Void> {
    ...
    String parseUrlParameter = "http://222.122.203.55/realreview/reviewScore/reviewUsefulUp.php?";
    private MaterialDialog builder;


    public AsyncReviewUsefulUp(String iShopID, String iUserID, String iNick, String iIdx, Context mContext) {
