...
public class ShopDetail_Answer_Viewing_Viewholder_Answer extends RecyclerView.ViewHolder {
    ...
    public ShopDetail_Answer_Viewing_Viewholder_Answer(View itemView) {
        super(itemView);
