...
public class AsyncReviewDelete extends AsyncTask<Void, Integer, Void> {


    private String params = "";
    String TestVAR;
    private Context mContext;
    private String iShopID, iUserID, iIdx;
    private String userLocationCheckResult;
    String parseUrlParameter = "http://222.122.203.55/realreview/reviewFix/reviewDelete.php?";
    private MaterialDialog builder;


    public AsyncReviewDelete(String iShopID, String iUserID, String iIdx, Context mContext) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        try {
            ...
            Log.d("AsyncDeleteSubmit", "parseUrlParameter : " + parameterCheck);
            Log.d("AsyncDeleteSubmit", "url : " + url);
            ...
            buffer.append("idx").append("=").append(iIdx);
            ...
            Log.d("AsyncDeleteSubmit", "전송결과 : " + result);
