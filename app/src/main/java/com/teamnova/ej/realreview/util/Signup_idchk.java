...
/**
 * Created by ej on 2017-09-14.
 */

public class Signup_idchk extends Thread {
    ...
    public Signup_idchk(String id, String name, String mail) { //for update

        //String findingpw="http://answerofgod.honor.es/study/android/login/sql/findingpw.php?id=";
        String findingpw = "http://222.122.203.55/android_test/findingpw.php?id=";  //your server IP
        String userId = id;
    ...
    public Signup_idchk(String pw, String mail) { //for update

        String findingpw = "http://222.122.203.55/android_test/sendingpw.php?msg=";     //your server IP
    ...
    public Signup_idchk(String id, String name, String age, String phone, String mail, String address) { //for update

        String userinfo_url = "http://222.122.203.55/android_test/updateUser.php?id=";      //your server IP
    ...
    public Signup_idchk(String id, String name, String age, String phone, String mail, String address, String pw) { //for register
        //String insert_userinfo_url="http://answerofgod.honor.es/study/android/login/sql/insertUser.php?id=";
        String insert_userinfo_url = "http://222.122.203.55/android_test/insertUser.php?id=";       //your server IP
        String userId = id;
        String nameuser = "&name=" + name;
        String ageuser = "&age=" + age;
        String phoneuser = "&phone=" + phone;
    ...
    public Signup_idchk(String id, String no, int type) {
        // String pwinfo_url="http://answerofgod.honor.es/study/android/login/sql/updatePw.php?id=";
        String pwinfo_url = "http://222.122.203.55/android_test/updatePw.php?id=";      //your server IP
        String userId = id;
    ...
    public Signup_idchk(String id, int type) {
        ...
        String userinfo_url = "http://222.122.203.55/android_test/getuserinfo.php?id=";     //your server IP
        String idchk_url = "http://222.122.203.55/android_test/chkid.php?id=";      //your server IP
        String userId = id;
