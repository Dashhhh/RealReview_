...
public class AsyncReviewCoolDown extends AsyncTask<Void, Integer, Void> {
    ...
    String parseUrlParameter = "http://222.122.203.55/realreview/reviewScore/reviewCoolDown.php?";
    private MaterialDialog builder;


    public AsyncReviewCoolDown(String iShopID, String iUserID, String iNick, String iIdx, Context mContext) {
