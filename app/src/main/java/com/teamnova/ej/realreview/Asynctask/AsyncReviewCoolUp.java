...
public class AsyncReviewCoolUp extends AsyncTask<Void, Integer, Void> {
    ...
    String parseUrlParameter = "http://222.122.203.55/realreview/reviewScore/reviewCoolUp.php?";
    private MaterialDialog builder;


    public AsyncReviewCoolUp(String iShopID, String iUserID, String iNick, String iIdx, Context mContext) {
