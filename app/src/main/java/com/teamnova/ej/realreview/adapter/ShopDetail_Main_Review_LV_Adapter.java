...
public class ShopDetail_Main_Review_LV_Adapter extends BaseAdapter {
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (!setData.titleImage.equals("")) {
            Glide.with(context).load(setData.titleImage).thumbnail(0.5f)
                    .apply(RequestOptions.bitmapTransform(new CircleCrop(context)))
                    .into(vh.reviewUserImage);
        } else {
            Glide.with(context).load("http://222.122.203.55/realreview/signup/profiledefault/default_food.png").thumbnail(0.5f)
                    .apply(RequestOptions.bitmapTransform(new CircleCrop(context)))
                    .into(vh.reviewUserImage);
        }


        vh.reviewGoodBtn.setOnCheckedChangedListener(null);
        vh.reviewCoolBtn.setOnCheckedChangedListener(null);
        vh.reviewUsefulBtn.setOnCheckedChangedListener(null);


        vh.reviewRegdate.setMarkdownText("{fa-clock-o} " + setData.regdate);
        vh.reviewUserId.setText(setData.getNick());
        vh.reviewReviewCount.setText(setData.getReviewCnt());
        vh.reviewUserFollower.setText(setData.getFollowerCnt());
        vh.reviewImageCount.setText(setData.getImageCnt());
        vh.reviewText.setText(setData.getReviewText());
        vh.reviewRating.setRating(setData.getfRating());
        ...
        if (checkUser.equals(setData.getNick())) {
            ...
            vh.reviewDelete.setVisibility(View.GONE);
            vh.reviewModify.setVisibility(View.GONE);
        }
